...
- if building agent related, use Guardrail AI library at inputs and outputs
 - inputs focus on filtering out before it reach llm agent
 - outputs focus on data structure and tone
